import { resourceFormattingScript } from "./resources.js";
import { addPlanetsToIconTooltipInGalaxyView, attachHandlerToSendProbe } from "./galaxy.js";
import { renderCargoCapacityForSelectedAmountOfShipsPictureClicked, renderCargoCapacityForSelectedAmountOfShipsInputChange, attachNecessaryMaxButton, removeAllCargoLabels } from './shipyard.js';
(async function () {
    window.bookmarks = {};
    ...
    const observerGalaxy = new MutationObserver((event) => {
        if (event[0].target.style.display === 'none') {
